...
public class ModerrAntyLogout implements Listener {
    ...
    public ModerrAntyLogout(){
        Bukkit.getScheduler().scheduleSyncRepeatingTask(Main.getInstance(), () -> {
            for(UUID uuid : antyLogout.keySet()){
                ...
                nowy.bossBar.setProgress((double) nowy.secounds/secounds);
                nowy.secounds--;
    ...
    public void setAntyLogout(Player p){
        AntyLogoutItem item = new AntyLogoutItem(p.getUniqueId(), secounds, Bukkit.createBossBar(ColorUtils.color("&aANTY LOGOUT"), BarColor.RED, BarStyle.SOLID));
